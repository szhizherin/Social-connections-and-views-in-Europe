...
formul_long <- Happiness ~ EU_friends_abroad +
  ED3_4 + ED5_8 + 
...
formul_short <- Happiness ~ EU_friends_abroad +
  ED5_8 + 
  Y10_19 + Y20_29 + Y30_39 + Y40_49 + Y50_59 + Y60_69 + Y70_MAX + 
...
moran.mc(world_values_survey$Happiness, mat2listw(SCI_W), nsim = 1000)
moran.mc(world_values_survey$Happiness, mat2listw(distance_W), nsim = 1000)
moran.mc(world_values_survey$Happiness, mat2listw(sq_distance_W), nsim = 1000)
...
SEM_distance_long <- errorsarlm(formul_long, data = world_values_survey, listw = mat2listw(distance_W))
summary(SEM_distance_long, Nagelkerke = TRUE, signif.stars = TRUE)
