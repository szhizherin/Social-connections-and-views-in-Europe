...
formul_long <- Religion ~ EU_friends_abroad +
  ED3_4 + ED5_8 + 
...
formul_short <- Religion ~ EU_friends_abroad +
  ED5_8 + 
  Y10_19 + Y20_29 + Y30_39 + Y40_49 + Y50_59 + Y60_69 + Y70_MAX + 
...
moran.mc(world_values_survey$Religion, mat2listw(SCI_W), nsim = 1000)
moran.mc(world_values_survey$Religion, mat2listw(distance_W), nsim = 1000)
moran.mc(world_values_survey$Religion, mat2listw(sq_distance_W), nsim = 1000)
...
SAR_SCI_short <- lagsarlm(formul_short, data = world_values_survey, listw = mat2listw(SCI_W))
...
SAR_placebo_short <- lagsarlm(formul_short, data = world_values_survey, listw = mat2listw(placebo))
...
rob_check_short_SCI <- check_results(data = world_values_survey, mat = SCI_W, est_function = lagsarlm, 
