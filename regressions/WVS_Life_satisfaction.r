...
formul_long <- Life_satisfaction ~ EU_friends_abroad +
  ED3_4 + ED5_8 + 
...
formul_short <- Life_satisfaction ~ EU_friends_abroad +
  ED5_8 + 
  Y10_19 + Y20_29 + Y30_39 + Y40_49 + Y50_59 + Y60_69 + Y70_MAX + 
...
moran.mc(world_values_survey$Life_satisfaction, mat2listw(SCI_W), nsim = 1000)
moran.mc(world_values_survey$Life_satisfaction, mat2listw(distance_W), nsim = 1000)
moran.mc(world_values_survey$Life_satisfaction, mat2listw(sq_distance_W), nsim = 1000)
